        ...
        {cartItems.length === 0 ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 flex flex-col md:flex-row">
            ...
            <div className="md:w-1/3 p-8 bg-gray-50">
              ...
              <button className="w-full bg-gray-900 hover:bg-teal-600 text-white font-bold py-4 rounded-xl shadow-lg transition-transform transform hover:-translate-y-1 mb-4">
                Secure Checkout
              </button>
